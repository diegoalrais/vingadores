...
<html>
    ...
    <body>
        ...
        <footer>
            <p id="rodape">UNICESUMAR / SISTEMAS PARA INTERNET</p>
            <p id="rodape">MAPA - PROGRAMAÇÃO AVANÇADA</p>
            <p id="rodape">Desenvolvido por Antonio Diego Almeida de Morais</p>
            <p id="rodape">RA: 1979883-5</p>
        </footer>
    </body>
</html>
